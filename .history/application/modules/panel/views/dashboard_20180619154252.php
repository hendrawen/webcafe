...
<link href="<?=base_url('assets/pos/');?>css/bootstrap.min.css" rel="stylesheet">
<link href="<?=base_url('assets/pos/');?>css/bootstrap-responsive.min.css" rel="stylesheet">
<link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600"
        rel="stylesheet">
<link href="<?=base_url('assets/pos/');?>css/font-awesome.css" rel="stylesheet">
<link href="<?=base_url('assets/pos/');?>css/style.css" rel="stylesheet">
<link href="<?=base_url('assets/pos/');?>css/pages/dashboard.css" rel="stylesheet">
...
<?php $this->load->view('layout/subnavbar');?>
<!-- /navbar -->
...
<script src="<?=base_url('assets/pos/');?>js/jquery-1.7.2.min.js"></script> 
<script src="<?=base_url('assets/pos/');?>js/excanvas.min.js"></script> 
<script src="<?=base_url('assets/pos/');?>js/chart.min.js" type="text/javascript"></script> 
<script src="<?=base_url('assets/pos/');?>js/bootstrap.js"></script>
<script language="javascript" type="text/javascript" src="<?=base_url('assets/pos/');?>js/full-calendar/fullcalendar.min.js"></script>
 
<script src="<?=base_url('assets/pos/');?>js/base.js"></script> 
<script>     
